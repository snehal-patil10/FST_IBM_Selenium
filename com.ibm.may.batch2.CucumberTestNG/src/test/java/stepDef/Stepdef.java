...
public class Stepdef extends BaseClass
{
	...
	@Before
	public void setup(Scenario scName) throws IOException
	{
		//Logging
		...
		logger.info("ScnearioName: " + scName.getName());
	...
	@BeforeStep
	public void executeBeforeEachLine() {
		
		System.out.println("====================executeBeforeEachLine=====================");
	}
	...
	public void user_click_on_customers_Menu() throws InterruptedException {
		...
		//addCust.clickOnCustomersMenuUsingFindBy();
	...
	public void user_enter_customer_info() throws InterruptedException {
		...
		email = randomestring() + "_demo@ibmlearning.com";
		
		
		System.out.println("Email Value: " + email);
		
		logger.info("Email id uses for add customer page: " + email);
	...
	public void user_can_view_confirmation_message(String expectedValue) {
